...
extern  FILE *freopen(const char * __restrict /*filename*/,
    ...
    */
extern  void setbuf(FILE * __restrict /*stream*/,
                    char * __restrict /*buf*/);
   /*
    ...
    * Returns: no value.
    */
extern  int setvbuf(FILE * __restrict /*stream*/,
                   char * __restrict /*buf*/,
...
extern  int fprintf(FILE * __restrict /*stream*/,
    ...
    */
#pragma __printf_args
extern  int _fprintf(FILE * __restrict /*stream*/,
                     const char * __restrict /*format*/, ...) ;
   /*
...
extern  int printf(const char * __restrict /*format*/, ...);
    ...
    */
#pragma __printf_args
extern  int _printf(const char * __restrict /*format*/, ...);
   /*
...
extern  int sprintf(char * __restrict /*s*/, const char * __restrict /*format*/, ...) ;
    ...
    */
#pragma __printf_args
extern  int _sprintf(char * __restrict /*s*/, const char * __restrict /*format*/, ...) ;
   /*
...
#pragma __printf_args
extern  int snprintf(char * __restrict /*s*/, size_t /*n*/,
                     const char * __restrict /*format*/, ...);
   /*
    * is equivalent to fprintf, except that the argument s specifies an array
    * into which the generated output is to be written, rather than to a
...
#endif
#pragma __printf_args
extern  int _snprintf(char * __restrict /*s*/, size_t /*n*/,
                      const char * __restrict /*format*/, ...);
   /*
...
extern  int fscanf(FILE * __restrict /*stream*/,
    ...
    */
#pragma __scanf_args
extern  int _fscanf(FILE * __restrict /*stream*/,
                     const char * __restrict /*format*/, ...) ;
   /*
...
extern  int scanf(const char * __restrict /*format*/, ...);
    ...
    */
#pragma __scanf_args
extern  int _scanf(const char * __restrict /*format*/, ...);
   /*
...
extern  int sscanf(const char * __restrict /*s*/,
    ...
    */
#pragma __scanf_args
extern  int _sscanf(const char * __restrict /*s*/,
                     const char * __restrict /*format*/, ...) ;
   /*
...
#if !defined(__STRICT_ANSI__) || (defined(__STDC_VERSION__) && 199901L <= __STDC_VERSION__)
/* C99 additions */
extern  int vfscanf(FILE * __restrict /*stream*/, const char * __restrict /*format*/, __va_list) ;
extern  int vscanf(const char * __restrict /*format*/, __va_list);
extern  int vsscanf(const char * __restrict /*s*/, const char * __restrict /*format*/, __va_list) ;
#endif
extern  int _vfscanf(FILE * __restrict /*stream*/, const char * __restrict /*format*/, __va_list) ;
extern  int _vscanf(const char * __restrict /*format*/, __va_list);
extern  int _vsscanf(const char * __restrict /*s*/, const char * __restrict /*format*/, __va_list) ;

extern  int vprintf(const char * __restrict /*format*/, __va_list /*arg*/);
   /*
    ...
    *          output error occurred.
    */
extern  int _vprintf(const char * __restrict /*format*/, __va_list /*arg*/);
   /*
...
extern  int vfprintf(FILE * __restrict /*stream*/,
    ...
    *          output error occurred.
    */
extern  int vsprintf(char * __restrict /*s*/,
                     const char * __restrict /*format*/, __va_list /*arg*/) ;
   /*
...
extern  int vsnprintf(char * __restrict /*s*/, size_t /*n*/,
    ...
    */
#endif
extern  int _vsprintf(char * __restrict /*s*/,
                      const char * __restrict /*format*/, __va_list /*arg*/) ;
   /*
    ...
    * Returns: as vsprintf.
    */
extern  int _vfprintf(FILE * __restrict /*stream*/,
                     const char * __restrict /*format*/, __va_list /*arg*/) ;
   /*
    ...
    * Returns: as vfprintf.
    */
extern  int _vsnprintf(char * __restrict /*s*/, size_t /*n*/,
                      const char * __restrict /*format*/, __va_list /*arg*/);
   /*
...
extern  int fgetc(FILE * /*stream*/);
    ...
    */
extern  char *fgets(char * __restrict /*s*/, int /*n*/,
                    FILE * __restrict /*stream*/);
   /*
...
extern  int ungetc(int /*c*/, FILE * /*stream*/);
    ...
    * rewind) discards any pushed-back characters. The extern al storage
...
extern  size_t fread(void * __restrict /*ptr*/,
...
extern  size_t __fread_bytes_avail(void * __restrict /*ptr*/,
...
extern  size_t fwrite(const void * __restrict /*ptr*/,
                    size_t /*size*/, size_t /*nmemb*/, FILE * __restrict /*stream*/);
   /*
...
extern  int fseek(FILE * /*stream*/, long int /*offset*/, int /*whence*/);
    ...
    */
extern  int fsetpos(FILE * __restrict /*stream*/, const fpos_t * __restrict /*pos*/) ;
   /*
    * sets  the file position indicator for the stream pointed to by stream

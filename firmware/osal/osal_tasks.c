...
#if defined ( OSAL_CBTIMER_NUM_TASKS ) && (OSAL_CBTIMER_NUM_TASKS != 0)
  OSAL_CBTIMER_PROCESS_EVENT( osal_CbTimerProcessEvent ),           // task 1
#endif
  HciWiFi_ProcessEvent,                                             // task 2
  AppLock_ProcessEvent                                              // task 3 
};

const uint8_t tasksCnt = sizeof( tasksArr ) / sizeof( tasksArr[0] );
uint16_t tasksEvents[sizeof( tasksArr ) / sizeof( tasksArr[0] )];

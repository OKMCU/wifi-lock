 ...
 */
  ...
  /*
   * Update the OSAL systick in timer ISR
   */
  extern void osalSystickUpdate( void );
  /*
  ...
  /*
   * Gets the current time of millisecond as a compensation of osal_getclock().  
   * This will only return the milliseconds portion of time and doesn't include 
   * the seconds portion.
   *     returns: number of milliseconds.
   */
  extern uint16_t osal_getClockMSec( void );

...
static void osalClockUpdate( uint16_t elapsedMSec );

/*********************************************************************
 * FUNCTIONS
 *********************************************************************/

void osalSystickUpdate( void )
{
    systick++;
}
...
void osalTimeUpdate( void )
{
    ...
    if ( curSystick != preSystick )
    {
        // Update OSAL Clock and Timers

        if(curSystick > preSystick)
        {
            elapsedMSec = curSystick - preSystick;
        }
        else
        {
            elapsedMSec = UINT16_MAX - preSystick + curSystick;
        }

        preSystick = curSystick;
...
uint16_t osal_getClockMSec( void )
{
    return timeMSec;
}
/*********************************************************************
